...
import com.friendly_machines.intellij.plugins.ideanative2debugger.ThrowedCatchpointType;
...
public class ThrowedCatchpointHandler extends XBreakpointHandler<XBreakpoint<ThrowedCatchpointProperties>> {
    private final DebugProcess myDebugProcess;

    public ThrowedCatchpointHandler(DebugProcess debugProcess, final Class<? extends ThrowedCatchpointType> typeClass) {
        super(typeClass);
        myDebugProcess = debugProcess;
    }

    @Override
    public void registerBreakpoint(@NotNull XBreakpoint<ThrowedCatchpointProperties> breakpoint) {
     ...
     */
    @Override
    public void unregisterBreakpoint(@NotNull XBreakpoint<ThrowedCatchpointProperties> key, final boolean temporary) {
        final BreakpointManager manager = myDebugProcess.getBreakpointManager();
        try {
